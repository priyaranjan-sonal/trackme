          ...
          {loading ? (
            ...
            <>
              ...
              <div className="relative" ref={menuRef}>
                ...
                {menuOpen && (
                  <div className="absolute top-full right-0 mt-2 w-44 overflow-hidden rounded-2xl border border-white/[0.08] bg-prsSurface shadow-[0_24px_60px_rgba(0,0,0,0.7)] animate-scale-in">
                    <Link
                      href="/profile"
                      onClick={() => setMenuOpen(false)}
                      className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white/80 transition-colors hover:bg-white/[0.06] hover:text-white"
                    >
                    ...
                    <button
                      ...
                      className="flex w-full cursor-pointer items-center gap-2 border-t border-white/[0.06] px-4 py-2.5 text-sm font-medium text-red-400 transition-colors hover:bg-red-500/10"
                    >
